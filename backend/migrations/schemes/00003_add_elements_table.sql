...
(
    ...
    CONSTRAINT elements_page_length
        CHECK (char_length(page) BETWEEN 1 AND 2048)
);
...
CREATE INDEX elements_active_project_page_idx
    ON onboarding.elements (project_id, page)
    WHERE deleted_at IS NULL;
